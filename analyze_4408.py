...
# Check if this is actually a different format
print(f'Next 8 bytes after Vector4s: {data[offset:offset+8].hex()}')

# Try reading as u32 instead of u16+u16
possible_u32 = struct.unpack('<I', data[offset:offset+4])[0]
print(f'As u32: 0x{possible_u32:08X}')
