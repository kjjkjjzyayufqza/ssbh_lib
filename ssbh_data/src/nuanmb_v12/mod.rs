...
pub use translate::{
    decode_scale_3200, decode_scale_3208, decode_scale_3209, decode_scale_3300,
    decode_scale_3308, decode_scale_3309, decode_scale_3400, decode_scale_3408,
    decode_scale_3409, decode_translate_3200, decode_translate_3208, decode_translate_3209,
    decode_translate_3300, decode_translate_3308, decode_translate_3309, decode_translate_3400,
...
mod tests {
    ...
    fn residual_component_advances_cursor_and_decodes() {
        ...
        let local_idx = 1;
        let block_len = 4;
        let (value, next) = common::decode_residual_component(
            &residual,
            0,
            base_scale,
            local_idx,
